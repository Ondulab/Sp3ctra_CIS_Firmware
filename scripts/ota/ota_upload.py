    ...
    try:
        ...
        while sent < total:
            ...
            try:
                ...
                # le cas nominal d'un refus (en-tete multipart invalide). La
                # reponse est peut-etre deja dans le tampon de reception -- la
                # lire vaut mieux que rapporter un tuyau casse.
                early = b""
                try:
                    sock.settimeout(2.0)
                    while True:
