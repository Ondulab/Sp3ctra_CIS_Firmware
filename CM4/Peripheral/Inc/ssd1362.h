...
/** drawString with a vertical clip window [y_min..y_max] — glyph rows outside are skipped
 *  (both fonts advance 8 px per character; size selects the 8 or 16 px tall face). */
